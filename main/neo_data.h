...
#define NEO_SEQ_STRATEGIES 9       // number of strategies defined (i.e. size of array of strategy callbacks)
 ...
 */
#define   NEO_OLD_SUCCESS         3  // button same as current, no change
